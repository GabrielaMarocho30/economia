...
<body>
    ...
    if(isset($_POST['prestamo']) && isset($_POST['tiempo']) && isset($_POST['tasa'])){
        ...
        $amortizacion = $prestamo / $tiempo; // calcular la amortización del periodo
    
        echo "<h4>Interes: $interes</h4>";
    
        echo "<h2>Tabla de amortización</h2>";
        echo "<table border='1'>";
        echo "<tr><th>Período</th><th>Interés</th><th>Mensualidad</th><th>Amortización</th><th>Saldo</th></tr>";
        for ($i=0; $i<=$tiempo; $i++){
            echo "<tr>";
            echo "<td>$i</td>";
            ...
            if ($i == 0) {
                ...
                $mensualidad = $interes + floatval($amortizacion); // calcular el interés del periodo
